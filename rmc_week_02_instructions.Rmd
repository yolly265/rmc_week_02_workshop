...
Then render the main `burden_of_disease_report.Rmd` which will pull in the completed child docs. Make sure that only key outputs are displayed in the main report, not the code or package loading messages. The render output should be in github_document format.
